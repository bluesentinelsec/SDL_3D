...
static const action_validation_rule *find_action_validation_rule(const char *type)
{
    static const action_validation_rule rules[] = {
        ...
        ACTION_RULE_EXACT_HANDLER("editor.visibility.focus_hidden", validate_noop_action),
        ACTION_RULE_EXACT_HANDLER("editor.visibility.show_focused", validate_noop_action),
