...
static const action_validation_rule *find_action_validation_rule(const char *type)
{
    static const action_validation_rule rules[] = {
        ...
        ACTION_RULE_EXACT_HANDLER("editor.selection.copy", validate_editor_selection_clipboard_action),
        ACTION_RULE_EXACT_HANDLER("editor.selection.cut", validate_editor_selection_clipboard_action),
        ACTION_RULE_EXACT_HANDLER("editor.selection.paste", validate_editor_selection_clipboard_action),
        ACTION_RULE_EXACT_HANDLER("editor.selection.delete_selected", validate_editor_selection_delete_selected_action),
        ACTION_RULE_EXACT_HANDLER("editor.visibility.hide_selected", validate_noop_action),
        ACTION_RULE_EXACT_HANDLER("editor.visibility.show_all", validate_noop_action),
        ACTION_RULE_EXACT_HANDLER("editor.lock.lock_selected", validate_noop_action),
        ACTION_RULE_EXACT_HANDLER("editor.lock.unlock_selected", validate_noop_action),
        ACTION_RULE_EXACT_HANDLER("editor.lock.unlock_all", validate_noop_action),
        ACTION_RULE_EXACT_HANDLER("editor.stair.toggle_direction", validate_noop_action),
        ACTION_RULE_EXACT_HANDLER("editor.stair.add_step", validate_noop_action),
        ACTION_RULE_EXACT_HANDLER("editor.stair.remove_step", validate_noop_action),
