function(_slayer3d_hex_to_c_array out_var hex)
    if("${hex}" STREQUAL "")
...
if(NOT INPUT_PACK OR NOT OUTPUT_C OR NOT OUTPUT_H OR NOT SYMBOL)
    message(FATAL_ERROR "Slayer3DEmbedAssetPack.cmake requires INPUT_PACK, OUTPUT_C, OUTPUT_H, and SYMBOL")
endif()
...
_slayer3d_hex_to_c_array(_pack_array "${_pack_hex}")
