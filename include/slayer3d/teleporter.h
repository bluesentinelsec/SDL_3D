...
#ifndef SLAYER3D_TELEPORTER_H
#define SLAYER3D_TELEPORTER_H
...
#define SLAYER3D_SIGNAL_TELEPORT 0x54454C45
     ...
     * axis.
     */
    typedef struct slayer3d_teleport_destination
    {
        slayer3d_vec3 position; /**< Caller-defined destination position. */
    ...
    } slayer3d_teleport_destination;

    /**
     * @brief Teleporter trigger volume.
     *
     * Initialize with slayer3d_teleporter_init(), then call
     * slayer3d_teleporter_update() once per simulation tick using the point that
     ...
     * inside.
     */
    typedef struct slayer3d_teleporter
    {
        slayer3d_bounding_box source_bounds;       /**< World-space source volume. */
        slayer3d_teleport_destination destination; /**< Payload destination. */
        int teleporter_id;                         /**< Stable game/editor id included in the payload. */
        int signal_id;                             /**< Signal to emit, or SLAYER3D_SIGNAL_TELEPORT by default. */
     ...
     *
     * The teleporter starts enabled, emits SLAYER3D_SIGNAL_TELEPORT, and uses a
     * short default cooldown suitable for paired or nearby teleport volumes.
     */
    void slayer3d_teleporter_init(slayer3d_teleporter *teleporter, int teleporter_id,
                                  slayer3d_bounding_box source_bounds, slayer3d_teleport_destination destination);
