#ifndef SLAYER3D_IMAGE_H
#define SLAYER3D_IMAGE_H
...
extern "C"
{
    ...
    /*
     * 8-bit-per-channel image owned by SLAYER3D. Pixels are stored row-major,
     ...
     * populated and the caller owns the allocation until slayer3d_free_image.
     */
     ...
     * as produced by slayer3d_load_image_*. Returns false on I/O failure.
     */
