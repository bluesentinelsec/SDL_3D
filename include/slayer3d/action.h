 ...
 *   slayer3d_action lock_door = {0};
 *   lock_door.type = SLAYER3D_ACTION_SET_PROPERTY;
 *   lock_door.set_property.target = door_props;
 *   lock_door.set_property.key = "locked";
 *   lock_door.set_property.value.type = SLAYER3D_VALUE_BOOL;
 *   lock_door.set_property.value.as_bool = true;
 *
 *   slayer3d_action_execute(&lock_door, bus, NULL);
 * @endcode
 */

#ifndef SLAYER3D_ACTION_H
#define SLAYER3D_ACTION_H
...
extern "C"
{
    ...
    /** @brief Action types. */
    typedef enum slayer3d_action_type
    {
        SLAYER3D_ACTION_SET_PROPERTY, /**< Write a value to a property bag. */
        SLAYER3D_ACTION_EMIT_SIGNAL,  /**< Emit another signal via the bus. */
        SLAYER3D_ACTION_START_TIMER,  /**< Start a timer (requires Phase 5). */
        SLAYER3D_ACTION_LOG,          /**< Log a debug message via SDL_Log. */
    } slayer3d_action_type;
     ...
     */
    typedef struct slayer3d_action
    {
        slayer3d_action_type type;
        ...
        union {
             ...
             *
             * No-op if the timer_pool argument to slayer3d_action_execute
     ...
     */
    void slayer3d_action_execute(const slayer3d_action *action, slayer3d_signal_bus *bus,
                                 slayer3d_timer_pool *timer_pool);
