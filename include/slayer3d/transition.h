 ...
 * machine is renderer-independent; slayer3d_transition_draw dispatches to the
 * active backend.
 */

#ifndef SLAYER3D_TRANSITION_H
#define SLAYER3D_TRANSITION_H
...
#define SLAYER3D_TRANSITION_MELT_COLUMNS 320

    /**
     * @brief Visual effect used for a screen transition.
     */
    typedef enum slayer3d_transition_type
    {
        SLAYER3D_TRANSITION_FADE = 0,     /**< Linear blend to or from a solid color. */
        SLAYER3D_TRANSITION_CIRCLE = 1,   /**< Centered circular reveal or cover. */
        SLAYER3D_TRANSITION_MELT = 2,     /**< Doom-style staggered column melt. */
        SLAYER3D_TRANSITION_PIXELATE = 3, /**< Pixel block dissolve approximation. */
    } slayer3d_transition_type;

    /**
     * @brief Whether a transition reveals the scene or covers it.
     */
    typedef enum slayer3d_transition_direction
    {
        SLAYER3D_TRANSITION_IN = 0,  /**< Effect recedes and reveals the scene. */
        SLAYER3D_TRANSITION_OUT = 1, /**< Effect grows and covers the scene. */
    } slayer3d_transition_direction;
     ...
     * Use slayer3d_transition_start to initialize and begin an effect, then call
     * slayer3d_transition_update once per simulation tick and
     * slayer3d_transition_draw once per rendered frame.
     */
    typedef struct slayer3d_transition
    {
        slayer3d_transition_type type;                        /**< Transition visual effect. */
        slayer3d_transition_direction direction;              /**< Reveal or cover direction. */
        slayer3d_color color;                                 /**< Solid transition color. */
        ...
        float melt_offsets[SLAYER3D_TRANSITION_MELT_COLUMNS]; /**< Deterministic per-column melt offsets. */
    } slayer3d_transition;
