...
#ifndef SLAYER3D_LOGIC_H
#define SLAYER3D_LOGIC_H
...
#define SLAYER3D_LOGIC_MAX_ENTITY_OUTPUTS 8
...
extern "C"
{
     ...
     * indices directly or names registered with slayer3d_logic_world_set_sector_name().
     */
    typedef enum slayer3d_logic_target_kind
    {
        SLAYER3D_LOGIC_TARGET_NONE = 0,         /**< Invalid/no target. */
        SLAYER3D_LOGIC_TARGET_ACTOR_ID = 1,     /**< Actor registry id. */
        SLAYER3D_LOGIC_TARGET_ACTOR_NAME = 2,   /**< Actor registry name. */
        SLAYER3D_LOGIC_TARGET_SECTOR_INDEX = 3, /**< Sector index in the active level. */
        SLAYER3D_LOGIC_TARGET_SECTOR_NAME = 4,  /**< Name registered for a sector index. */
    } slayer3d_logic_target_kind;
     ...
     */
    typedef struct slayer3d_logic_target_ref
    {
        slayer3d_logic_target_kind kind;
        union {
            int actor_id;            /**< Used by SLAYER3D_LOGIC_TARGET_ACTOR_ID. */
            const char *actor_name;  /**< Used by SLAYER3D_LOGIC_TARGET_ACTOR_NAME. */
            int sector_index;        /**< Used by SLAYER3D_LOGIC_TARGET_SECTOR_INDEX. */
            const char *sector_name; /**< Used by SLAYER3D_LOGIC_TARGET_SECTOR_NAME. */
        };
    } slayer3d_logic_target_ref;
     ...
     */
    typedef struct slayer3d_logic_target_context
    {
        slayer3d_actor_registry *registry; /**< Actor registry for actor references. May be NULL. */
        slayer3d_level *level;             /**< Active level for sector references. May be NULL. */
        slayer3d_sector *sectors;          /**< Mutable sector definitions matching @p level. May be NULL. */
        int sector_count;                  /**< Number of entries in @p sectors. */
    } slayer3d_logic_target_context;
     ...
     */
    typedef struct slayer3d_logic_resolved_target
    {
        slayer3d_logic_target_kind kind;
        union {
            slayer3d_registered_actor *actor; /**< Resolved actor for actor references. */
            struct
            {
                slayer3d_level *level;   /**< Level supplied in the target context. */
                slayer3d_sector *sector; /**< Resolved sector definition. */
                int sector_index;        /**< Resolved sector index. */
            } sector;
        };
    } slayer3d_logic_resolved_target;

    /**
     * @brief Target-aware action type for designer-authored gameplay logic.
     *
     * These actions extend the lower-level slayer3d_action vocabulary with effects
     * that need logic-world target resolution. Existing slayer3d_action values are
     * still supported through SLAYER3D_LOGIC_ACTION_CORE.
     */
    typedef enum slayer3d_logic_action_type
    {
        SLAYER3D_LOGIC_ACTION_NONE = 0,                 /**< Invalid/no action. */
        SLAYER3D_LOGIC_ACTION_CORE = 1,                 /**< Execute an embedded slayer3d_action. */
        SLAYER3D_LOGIC_ACTION_SET_ACTOR_ACTIVE = 2,     /**< Set a resolved actor's active flag. */
        SLAYER3D_LOGIC_ACTION_TOGGLE_ACTOR_ACTIVE = 3,  /**< Toggle a resolved actor's active flag. */
        SLAYER3D_LOGIC_ACTION_SET_ACTOR_PROPERTY = 4,   /**< Set a property on a resolved actor. */
        SLAYER3D_LOGIC_ACTION_SET_SECTOR_PUSH = 5,      /**< Set a sector push/current velocity. */
        SLAYER3D_LOGIC_ACTION_SET_SECTOR_DAMAGE = 6,    /**< Set non-negative sector damage per second. */
        SLAYER3D_LOGIC_ACTION_SET_SECTOR_AMBIENT = 7,   /**< Set a non-negative ambient sound id. */
        SLAYER3D_LOGIC_ACTION_TELEPORT_PLAYER = 8,      /**< Request a game-owned player teleport. */
        SLAYER3D_LOGIC_ACTION_SET_ACTIVE_CAMERA = 9,    /**< Request a game-owned active camera override. */
        SLAYER3D_LOGIC_ACTION_RESTORE_CAMERA = 10,      /**< Request restoration of the game-owned camera. */
        SLAYER3D_LOGIC_ACTION_SET_AMBIENT = 11,         /**< Request a game-owned ambient audio transition. */
        SLAYER3D_LOGIC_ACTION_TRIGGER_FEEDBACK = 12,    /**< Request a named game-owned feedback cue. */
        SLAYER3D_LOGIC_ACTION_DOOR_COMMAND = 13,        /**< Request a game-owned door command. */
        SLAYER3D_LOGIC_ACTION_SET_SECTOR_GEOMETRY = 14, /**< Request a game-owned sector geometry change. */
        SLAYER3D_LOGIC_ACTION_LAUNCH_PLAYER = 15,       /**< Request a game-owned player launch impulse. */
        SLAYER3D_LOGIC_ACTION_SET_EFFECT_ACTIVE = 16    /**< Request a game-owned named effect enable/disable. */
    } slayer3d_logic_action_type;

    /**
     * @brief Command issued to a game-owned door.
     */
    typedef enum slayer3d_logic_door_command
    {
        SLAYER3D_LOGIC_DOOR_OPEN = 0,   /**< Open the target door. */
        SLAYER3D_LOGIC_DOOR_CLOSE = 1,  /**< Close the target door. */
        SLAYER3D_LOGIC_DOOR_TOGGLE = 2, /**< Toggle the target door. */
    } slayer3d_logic_door_command;
     ...
     */
    typedef bool (*slayer3d_logic_teleport_player_fn)(void *userdata, const slayer3d_teleport_destination *destination,
     ...
     */
    typedef bool (*slayer3d_logic_set_active_camera_fn)(void *userdata, const char *camera_name,
     ...
     */
    typedef bool (*slayer3d_logic_restore_camera_fn)(void *userdata, const slayer3d_properties *payload);
     ...
     */
    typedef bool (*slayer3d_logic_set_ambient_fn)(void *userdata, int ambient_id, float fade_seconds,
                                                  const slayer3d_properties *payload);
     ...
     */
    typedef bool (*slayer3d_logic_trigger_feedback_fn)(void *userdata, const char *feedback_name,
                                                       float duration_seconds, const slayer3d_properties *payload);
     ...
     */
    typedef bool (*slayer3d_logic_door_command_fn)(void *userdata, const char *door_name, int door_id,
     ...
     */
    typedef bool (*slayer3d_logic_set_sector_geometry_fn)(void *userdata, int sector_index,
                                                          const slayer3d_sector_geometry *geometry,
                                                          const slayer3d_properties *payload);
     ...
     */
    typedef bool (*slayer3d_logic_launch_player_fn)(void *userdata, slayer3d_vec3 velocity,
                                                    const slayer3d_properties *payload);
     ...
     */
    typedef bool (*slayer3d_logic_set_effect_active_fn)(void *userdata, const char *effect_name, bool active,
                                                        const slayer3d_properties *payload);
     ...
     */
    typedef struct slayer3d_logic_game_adapters
    {
        void *userdata;                                            /**< Caller-owned data passed to every callback. */
        slayer3d_logic_teleport_player_fn teleport_player;         /**< Optional player teleport adapter. */
        slayer3d_logic_set_active_camera_fn set_active_camera;     /**< Optional camera override adapter. */
        slayer3d_logic_restore_camera_fn restore_camera;           /**< Optional camera restore adapter. */
        slayer3d_logic_set_ambient_fn set_ambient;                 /**< Optional ambient audio adapter. */
        slayer3d_logic_trigger_feedback_fn trigger_feedback;       /**< Optional named feedback adapter. */
        slayer3d_logic_door_command_fn door_command;               /**< Optional door command adapter. */
        slayer3d_logic_set_sector_geometry_fn set_sector_geometry; /**< Optional sector geometry adapter. */
        slayer3d_logic_launch_player_fn launch_player;             /**< Optional player launch adapter. */
        slayer3d_logic_set_effect_active_fn set_effect_active;     /**< Optional named effect adapter. */
    } slayer3d_logic_game_adapters;

    /**
     * @brief Target-aware action executed by a logic world.
     *
     * Like slayer3d_action, this is a plain value type. It owns no pointers:
     ...
     */
    typedef struct slayer3d_logic_action
    {
        slayer3d_logic_action_type type;

        union {
            /** @brief Embedded low-level action. */
            slayer3d_action core;

            /** @brief Set or toggle actor active state. */
            struct
            {
                slayer3d_logic_target_ref target;
                bool active;
            } actor_active;
    ...
    } slayer3d_logic_action;

    /**
     * @brief Sensor event emitted by logic sensors.
     */
    typedef enum slayer3d_logic_sensor_event
    {
        SLAYER3D_LOGIC_SENSOR_EVENT_NONE = 0,  /**< No signal was emitted. */
        SLAYER3D_LOGIC_SENSOR_EVENT_ENTER = 1, /**< Sensor condition became true. */
        SLAYER3D_LOGIC_SENSOR_EVENT_EXIT = 2,  /**< Sensor condition became false. */
        SLAYER3D_LOGIC_SENSOR_EVENT_LEVEL = 3, /**< Sensor condition is true for this update. */
    } slayer3d_logic_sensor_event;

    /**
     * @brief Result returned by a sensor update.
     */
    typedef struct slayer3d_logic_sensor_result
    {
        bool emitted;                      /**< Whether a signal was emitted. */
        bool active;                       /**< Sensor condition after the update. */
        slayer3d_logic_sensor_event event; /**< Event kind emitted, or NONE. */
    } slayer3d_logic_sensor_result;
     ...
     */
    typedef struct slayer3d_logic_sector_sensor
    {
        int sensor_id;                    /**< Stable editor/game id included in payloads. */
        slayer3d_logic_target_ref sector; /**< Sector index/name target. */
        int signal_id;                    /**< Signal emitted when edge rules match. */
        slayer3d_trigger_edge edge;       /**< Enter/exit/both/level emission mode. */
        bool enabled;                     /**< Disabled sensors never emit. */
        bool was_inside;                  /**< Previous occupancy state, managed by update/reset. */
    } slayer3d_logic_sector_sensor;
     ...
     */
    typedef struct slayer3d_logic_proximity_sensor
    {
        int sensor_id;                   /**< Stable editor/game id included in payloads. */
        slayer3d_logic_target_ref actor; /**< Actor id/name target. */
        float radius;                    /**< Non-negative trigger radius in world units. */
        int signal_id;                   /**< Signal emitted when edge rules match. */
        slayer3d_trigger_edge edge;      /**< Enter/exit/both/level emission mode. */
        bool enabled;                    /**< Disabled sensors never emit. */
        bool was_inside;                 /**< Previous proximity state, managed by update/reset. */
    } slayer3d_logic_proximity_sensor;
     ...
     */
    typedef struct slayer3d_logic_sector_damage_sensor
    {
        int sensor_id;                   /**< Stable editor/game id included in payloads. */
        ...
        bool enabled;                    /**< Disabled sensors never emit. */
    } slayer3d_logic_sector_damage_sensor;

    /**
     * @brief Result returned by a logic entity activation.
     */
    typedef struct slayer3d_logic_entity_result
    {
     ...
     * passed to slayer3d_logic_branch_activate_with_payload().
     */
    typedef struct slayer3d_logic_branch
    {
        int entity_id;                    /**< Stable editor/game id included in payloads. */
        const slayer3d_properties *props; /**< Property bag to inspect. */
        const char *key;                  /**< Property key to compare. */
        slayer3d_value expected;          /**< Expected value. String pointer is borrowed. */
     ...
     */
    typedef struct slayer3d_logic_random
    {
        int entity_id;                                  /**< Stable editor/game id included in payloads. */
        int outputs[SLAYER3D_LOGIC_MAX_ENTITY_OUTPUTS]; /**< Candidate output signals. */
        int output_count;                               /**< Number of active entries in @p outputs. */
        unsigned int state;                             /**< Deterministic PRNG state. */
        bool enabled;                                   /**< Disabled selectors emit nothing. */
    } slayer3d_logic_random;

    /**
     * @brief Sequence entity that emits outputs in authored order.
     */
    typedef struct slayer3d_logic_sequence
    {
        int entity_id;                                  /**< Stable editor/game id included in payloads. */
        int outputs[SLAYER3D_LOGIC_MAX_ENTITY_OUTPUTS]; /**< Ordered output signals. */
        int output_count;                               /**< Number of active entries in @p outputs. */
     ...
     */
    typedef struct slayer3d_logic_timer
    {
        int entity_id;     /**< Stable editor/game id included in payloads. */
     ...
     * SLAYER3D_LOGIC_ACTION_SET_SECTOR_GEOMETRY actions when the floor has moved
     * far enough to merit a mesh rebuild.
     */
    typedef struct slayer3d_logic_sector_platform
    {
        int entity_id;                    /**< Stable editor/game id. */
        slayer3d_logic_target_ref sector; /**< Sector moved by this platform. */
    ...
    } slayer3d_logic_sector_platform;

    /**
     * @brief Result returned by a sector platform update.
     */
    typedef struct slayer3d_logic_sector_platform_result
    {
    ...
    } slayer3d_logic_sector_platform_result;
     ...
     * matching slayer3d_action_execute semantics.
     *
     ...
     * on the world with slayer3d_logic_world_set_sector_name().
     */
     ...
     */
    void slayer3d_logic_world_set_target_context(slayer3d_logic_world *world,
                                                 const slayer3d_logic_target_context *context);
     ...
     */
    void slayer3d_logic_world_set_game_adapters(slayer3d_logic_world *world,
                                                const slayer3d_logic_game_adapters *adapters);
     ...
     *
     * On failure, @p out_target is reset to SLAYER3D_LOGIC_TARGET_NONE when
    ...
    /** @brief Wrap an existing low-level slayer3d_action as a logic action. */
     ...
     */
    slayer3d_logic_action slayer3d_logic_action_make_set_actor_property(slayer3d_logic_target_ref target,
                                                                        const char *key, slayer3d_value value);
     ...
     *
     * The action decodes the payload with slayer3d_teleport_destination_from_payload().
     ...
     * Execution requires a set_ambient game adapter on the logic world.
     */
    slayer3d_logic_action slayer3d_logic_action_make_set_ambient_from_payload(const char *payload_key,
                                                                              float fade_seconds);
     ...
     * execution.
     */
    slayer3d_logic_action slayer3d_logic_action_make_trigger_feedback(const char *feedback_name,
                                                                      float duration_seconds);
     ...
     * slayer3d_logic_action_make_door_command_ex().
     */
     ...
     *
     * Core actions execute through slayer3d_action_execute using the world's signal
     ...
     * SLAYER3D_LOGIC_ACTION_TELEPORT_PLAYER actions created with
     * slayer3d_logic_action_make_teleport_player_from_payload().
     *
     * @return true when the action was valid and applied, false otherwise.
     */
    bool slayer3d_logic_world_execute_action_with_payload(slayer3d_logic_world *world,
     ...
     */
    void slayer3d_logic_sector_damage_sensor_init(slayer3d_logic_sector_damage_sensor *sensor, int sensor_id,
                                                  int signal_id, float minimum_damage_per_second);
     ...
     */
    bool slayer3d_logic_world_emit_signal(slayer3d_logic_world *world, int signal_id,
                                          const slayer3d_properties *payload);
    ...
    slayer3d_logic_entity_result slayer3d_logic_toggle_activate(slayer3d_logic_world *world,
    ...
    slayer3d_logic_entity_result slayer3d_logic_branch_activate(slayer3d_logic_world *world,
    ...
    slayer3d_logic_entity_result slayer3d_logic_random_activate(slayer3d_logic_world *world,
                                                                slayer3d_logic_random *random);
     ...
     */
    slayer3d_logic_sector_platform_result slayer3d_logic_sector_platform_update(
        slayer3d_logic_world *world, slayer3d_logic_sector_platform *platform, float dt);
    ...
    int slayer3d_logic_world_bind_sequence(slayer3d_logic_world *world, int signal_id,
                                           slayer3d_logic_sequence *sequence);
