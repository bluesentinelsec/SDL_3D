 ...
 *
 * SLAYER3D networking is intentionally small and opt-in. It provides a
...
#ifndef SLAYER3D_NETWORK_H
#define SLAYER3D_NETWORK_H
...
#define SLAYER3D_NETWORK_MAX_HOST_LENGTH 256
#define SLAYER3D_NETWORK_MAX_STATUS_LENGTH 128
#define SLAYER3D_NETWORK_MAX_PACKET_SIZE 1024
#define SLAYER3D_NETWORK_MAX_QUEUE_SIZE 8
#define SLAYER3D_NETWORK_MAX_DISCOVERY_RESULTS 8
#define SLAYER3D_NETWORK_DEFAULT_PORT 27183

    /** @brief Operating role for a direct-connect network session. */
    typedef enum slayer3d_network_role
    {
        SLAYER3D_NETWORK_ROLE_HOST = 0,   /**< Listen for one remote client and accept it. */
        SLAYER3D_NETWORK_ROLE_CLIENT = 1, /**< Connect to a remote host by host / port. */
    } slayer3d_network_role;

    /** @brief Lifecycle state for a network session. */
    typedef enum slayer3d_network_state
    {
        SLAYER3D_NETWORK_STATE_DISCONNECTED = 0, /**< No socket or no active connection. */
        SLAYER3D_NETWORK_STATE_CONNECTING,       /**< Client is resolving or handshaking. */
        SLAYER3D_NETWORK_STATE_WAITING,          /**< Host is listening for a client. */
        SLAYER3D_NETWORK_STATE_CONNECTED,        /**< Peer handshake completed. */
        SLAYER3D_NETWORK_STATE_REJECTED,         /**< Remote host rejected the connection. */
        SLAYER3D_NETWORK_STATE_TIMED_OUT,        /**< Connection or peer activity timed out. */
        SLAYER3D_NETWORK_STATE_ERROR,            /**< A fatal transport error occurred. */
    } slayer3d_network_state;
     ...
     */
    typedef struct slayer3d_network_session_desc
    {
        slayer3d_network_role role; /**< Host or client. */
    ...
    } slayer3d_network_session_desc;

    /** @brief Session discovery announcement returned by LAN scans. */
    typedef struct slayer3d_network_discovery_result
    {
        ...
        Uint64 last_seen_ms;
    } slayer3d_network_discovery_result;
     ...
     */
    typedef struct slayer3d_network_discovery_session_desc
    {
        ...
        Uint16 local_port;
    } slayer3d_network_discovery_session_desc;

    /** @brief Opaque LAN discovery scanner. */
    typedef struct slayer3d_network_discovery_session slayer3d_network_discovery_session;

    /** @brief Opaque direct-connect UDP session. */
    typedef struct slayer3d_network_session slayer3d_network_session;
     ...
     * - role: client
     * - host: NULL
     * - port: SLAYER3D_NETWORK_DEFAULT_PORT
     * - local_port: 0
     ...
     */
    bool slayer3d_network_session_create(const slayer3d_network_session_desc *desc,
                                         slayer3d_network_session **out_session);
