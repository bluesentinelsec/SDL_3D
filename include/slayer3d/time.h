 ...
 * physics. Call slayer3d_time_update() once per frame before any game logic.
 *
 * Usage:
 * @code
 *   // Game loop
 ...
 *       for (int i = 0; i < slayer3d_time_get_fixed_step_count(); i++)
 *           update_physics(slayer3d_time_get_fixed_delta_time());
 *
...
#ifndef SLAYER3D_TIME_H
#define SLAYER3D_TIME_H
...
extern "C"
{
     ...
     *
     * This is the real elapsed time since the last slayer3d_time_update(),
     ...
     *
     * @return Total game time in seconds since the first slayer3d_time_update().
     */
     ...
     *
     * @return Total real time in seconds since the first slayer3d_time_update().
     */
     ...
     *
     * After slayer3d_time_update(), this returns how many fixed-step
